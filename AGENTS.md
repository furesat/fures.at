...
### 2026-07-21: Furkan CV Multilingual Marketing Profile

#### Summary

Applied the owner-approved Marketing and Growth Specialist CV positioning across TR/EN/DE/ES in the `/furkanyonat` microsite while preserving existing project cards and routes. Shared contact data now uses the Austria phone/location consistently across languages, and the existing experience renderer remains safe for language-specific entries.
...
Existing `/furkanyonat/` metadata already reflects the marketing/growth positioning; multilingual runtime title and description now also align across TR/EN/DE/ES. No new public route was added.
