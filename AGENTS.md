...
## Güncel Görev Notu (2026-04-30)
- Ana sayfa hero alanı tüm dillerde (Almanca dahil) tek bir 3D kumaş/kağıt animasyon bileşeniyle (`FuresTechHero`) yönetilir.
- Hero zorunlu metinleri:
  - Navbar: `Fures Tech`
  - Başlık: `Websites that move, think and sell.`
  - CTA: `Start a Project` ve `Trigger Demo` (Trigger Demo, yüzey pulse tetikleme etkileşimini korur).
  - Hizmet kartları: `Premium Websites`, `AI Automation`, `Interactive Experiences`.
