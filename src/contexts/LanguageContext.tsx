...
const translations = {
  tr: {
    ...
    'contact.form_eyebrow': 'Hızlı iletişim formu',
    'contact.form_title': 'Proje mesajınız doğrudan Furkan Yonat\'a gelsin.',
    'contact.form_description': 'Formu doldurun; mesajınız furkanyonat@gmail.com teslim adresine gönderilir ve Netlify yedek kaydı da tutulur.',
    'contact.form_name': 'Adınız',
    'contact.form_name_placeholder': 'Ad Soyad',
    'contact.form_email': 'E-posta adresiniz',
    'contact.form_phone': 'Telefon / WhatsApp',
    'contact.form_message': 'Mesajınız',
    'contact.form_message_placeholder': 'Projenizi, web sitenizi veya ihtiyacınızı kısaca yazın...',
    'contact.form_delivery_note': 'Teslimat adresi: furkanyonat@gmail.com',
    'contact.form_submit': 'Mesajı Gönder',
    'contact.form_sending': 'Gönderiliyor...',
    'contact.form_success': 'Teşekkürler, mesajınız alındı. En kısa sürede dönüş yapılacak.',
    'contact.form_error': 'Mesaj gönderilemedi. Lütfen doğrudan furkanyonat@gmail.com adresine yazın.',
  ...
  en: {
    ...
    'contact.form_eyebrow': 'Fast contact form',
    'contact.form_title': 'Send your project message directly to Furkan Yonat.',
    'contact.form_description': 'Fill in the form; your message is delivered to furkanyonat@gmail.com with a Netlify backup record.',
    ...
    'contact.form_message_placeholder': 'Briefly describe your project, website or request...',
    'contact.form_delivery_note': 'Delivery address: furkanyonat@gmail.com',
    'contact.form_submit': 'Send Message',
    'contact.form_sending': 'Sending...',
    'contact.form_success': 'Thank you, your message was received. We will reply as soon as possible.',
    'contact.form_error': 'The message could not be sent. Please email furkanyonat@gmail.com directly.',
  ...
  ru: {
    ...
    'contact.form_eyebrow': 'Быстрая форма связи',
    'contact.form_title': 'Отправьте сообщение проекта напрямую Furkan Yonat.',
    'contact.form_description': 'Заполните форму; сообщение будет доставлено на furkanyonat@gmail.com, а резервная запись сохранится в Netlify.',
    'contact.form_name': 'Ваше имя',
    'contact.form_name_placeholder': 'Имя и фамилия',
    'contact.form_email': 'Ваш email',
    'contact.form_phone': 'Телефон / WhatsApp',
    'contact.form_message': 'Ваше сообщение',
    'contact.form_message_placeholder': 'Кратко опишите проект, сайт или запрос...',
    'contact.form_delivery_note': 'Адрес доставки: furkanyonat@gmail.com',
    'contact.form_submit': 'Отправить сообщение',
    'contact.form_sending': 'Отправляется...',
    'contact.form_success': 'Спасибо, ваше сообщение получено. Мы ответим как можно скорее.',
    'contact.form_error': 'Сообщение не отправлено. Пожалуйста, напишите напрямую на furkanyonat@gmail.com.',
  ...
  de: {
    ...
    'contact.form_eyebrow': 'Schnelles Kontaktformular',
    'contact.form_title': 'Senden Sie Ihre Projektanfrage direkt an Furkan Yonat.',
    'contact.form_description': 'Füllen Sie das Formular aus; Ihre Nachricht wird an furkanyonat@gmail.com zugestellt und zusätzlich in Netlify gesichert.',
    'contact.form_name': 'Ihr Name',
    'contact.form_name_placeholder': 'Vor- und Nachname',
    'contact.form_email': 'Ihre E-Mail',
    'contact.form_phone': 'Telefon / WhatsApp',
    'contact.form_message': 'Ihre Nachricht',
    'contact.form_message_placeholder': 'Beschreiben Sie kurz Ihr Projekt, Ihre Website oder Ihren Bedarf...',
    'contact.form_delivery_note': 'Zustelladresse: furkanyonat@gmail.com',
    'contact.form_submit': 'Nachricht senden',
    'contact.form_sending': 'Wird gesendet...',
    'contact.form_success': 'Vielen Dank, Ihre Nachricht wurde empfangen. Wir melden uns so schnell wie möglich.',
    'contact.form_error': 'Die Nachricht konnte nicht gesendet werden. Bitte schreiben Sie direkt an furkanyonat@gmail.com.',
