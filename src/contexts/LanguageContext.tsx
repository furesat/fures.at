...
const translations = {
  tr: {
    ...
    'projects.start.email_desc': 'office@fures.tech adresine proje beklentilerinizi paylaşın.',
    ...
    'appointment.badge': 'Randevu',
    'appointment.title': 'Görüşme için randevu alın.',
    'appointment.helper': 'Formu doldurun, uygun saati teyit etmek için size dönelim.',
    'appointment.phone': 'Telefon',
    'appointment.date': 'Tercih ettiğiniz tarih',
    'appointment.time': 'Tercih ettiğiniz saat',
    'appointment.time_placeholder': 'örn. 14:00 – 16:00 arası',
    'appointment.message': 'Konu',
    'appointment.message_placeholder': 'Görüşmede neyi konuşmak istersiniz?',
    'appointment.submit': 'Randevu talebi gönder',
    'appointment.close': 'Kapat',
    'appointment.success': 'Randevu talebiniz bize ulaştı. Uygun saati teyit etmek için 24 saat içinde döneceğiz.',
    'appointment.privacy': 'Bilgileriniz yalnızca randevu için kullanılır.',
    'appointment.open': 'Randevu al',
  },
  en: {
    // Header
    'nav.home': 'Home',
    ...
    'projects.start.email_desc': 'Share your goals with office@fures.tech and receive a tailored roadmap.',
    ...
    'appointment.title': 'Book a time to talk.',
    'appointment.helper': 'Fill in the form and we will come back to confirm a slot.',
    'appointment.phone': 'Phone',
    'appointment.date': 'Preferred date',
    'appointment.time': 'Preferred time',
    'appointment.time_placeholder': 'e.g. between 2 and 4 pm',
    'appointment.message': 'Topic',
    'appointment.message_placeholder': 'What would you like to cover in the call?',
    'appointment.submit': 'Request appointment',
    'appointment.close': 'Close',
    'appointment.success': 'Your request reached us. We will confirm a slot within 24 hours.',
    'appointment.privacy': 'Your details are used only to arrange this appointment.',
    'appointment.open': 'Book appointment',
  },
  ru: {
    // Header
    'nav.home': 'Главная',
    ...
    'projects.start.email_desc': 'Поделитесь задачами на office@fures.tech и получите персональный план.',
    ...
    'appointment.badge': 'Встреча',
    'appointment.title': 'Запишитесь на разговор.',
    'appointment.helper': 'Заполните форму, и мы вернёмся, чтобы подтвердить время.',
    'appointment.phone': 'Телефон',
    'appointment.date': 'Удобная дата',
    'appointment.time': 'Удобное время',
    'appointment.time_placeholder': 'напр. с 14:00 до 16:00',
    'appointment.message': 'Тема',
    'appointment.message_placeholder': 'Что вы хотели бы обсудить?',
    'appointment.submit': 'Запросить встречу',
    'appointment.close': 'Закрыть',
    'appointment.success': 'Заявка получена. Мы подтвердим время в течение 24 часов.',
    'appointment.privacy': 'Данные используются только для этой встречи.',
    'appointment.open': 'Записаться',
  },
  de: {
    // Nav
    'nav.home': 'Startseite',
    ...
    'projects.start.email_desc': 'Schreiben Sie uns an office@fures.tech — wir antworten innerhalb von 24 Stunden.',
    ...
    'appointment.badge': 'Termin',
    'appointment.title': 'Termin für ein Gespräch vereinbaren.',
    'appointment.helper': 'Formular ausfüllen — wir melden uns zur Bestätigung des Termins.',
    'appointment.phone': 'Telefon',
    'appointment.date': 'Wunschtermin',
    'appointment.time': 'Wunschzeit',
    'appointment.time_placeholder': 'z. B. zwischen 14 und 16 Uhr',
    'appointment.message': 'Thema',
    'appointment.message_placeholder': 'Worum soll es im Gespräch gehen?',
    'appointment.submit': 'Termin anfragen',
    'appointment.close': 'Schließen',
    'appointment.success': 'Ihre Anfrage ist eingegangen. Wir bestätigen den Termin innerhalb von 24 Stunden.',
    'appointment.privacy': 'Ihre Angaben werden nur für diesen Termin verwendet.',
    'appointment.open': 'Termin vereinbaren',
  }
};
